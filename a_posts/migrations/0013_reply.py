...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('a_posts', '0012_rename_author_post_comment_parent_post'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='a_posts.post')),
            ],
        ),
    ]
